...
const Title = () => {
  return (
    <section className="mb100 mobMb30">
      ...
      <div>
        <img src={Img.cp1} alt="" className="w-100 mobMb15" />
      </div>
    </section>
  );
};
  ...
  return (
    <section className="mb100 mobMb30">
      <Container className="overflow-hidden">
        <div>
          <img src={Img.cp2} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <Row className="gx-5">
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.cp3} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.cp4} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
        </Row>
        <div>
          <img src={Img.cp5} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.cp6} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.cp7} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.cp8} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <Row className="gx-5">
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.cp9} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.cp10} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
        </Row>
        <div>
          <img src={Img.cp11} alt="" className="w-100 mb50 mobMb30" />
        </div>
        ...
        <section>
          <div className="mb80 mobMb15 text-center">
            ...
            <div>
              <Link to="#">{Svg.arrowDiagnalWhite}</Link>
            </div>
          </div>
        </section>
      </Container>
