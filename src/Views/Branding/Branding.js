...
const BrandingProcess=()=>{
  ...
  return <section className="pt60 pb60">
    <Container> 
    ...
    Our Branding Process
            ...
            The execution of a rightly formulated brand strategy is going to make all the difference in the world when it means doing something truly amazing.
            </p>
    </div>
...
<div className="triggerArea mt30">
    ...
    {
      process==='pr1' &&   <Row className="gy-3 gx-5 align-items-center">
            <Col lg={4}>
            ...
            <p className="colorLightGrey mt40 fs18 mb30 mobFs15">
              ...
              reprehenderit facere! Consequatur
            </p>
            </Col>
            <Col lg={8}>
              <div className="mt40">
    ...
    {
      process==='pr2' &&   <Row className="gy-3 gx-5 align-items-center">
            <Col lg={4}>
            <h3 className="fs40 mb30 colorWhite fw500 mobFs33">
    ...
    {
      process==='pr3' &&   <Row className="gy-3 gx-5 align-items-center">
            <Col lg={4}>
            <h3 className="fs40 mb30 colorWhite fw500 mobFs33">
    ...
    {
      process==='pr4' &&   <Row className="gy-3 gx-5 align-items-center">
            <Col lg={4}>
            <h3 className="fs40 mb30 colorWhite fw500 mobFs33">
              Don’t think of us as 
            </h3>
