...
const Title = () => {
  return (
    <section className="mb100 mobMb30">
      ...
      <div>
        <img src={Img.h1} alt="" className="w-100 mobMb15" />
      </div>
    </section>
  );
};
  ...
  return (
    <section className="mb100 mobMb30">
      <Container className="overflow-hidden">
        <div>
          <img src={Img.h2} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <Row className="gx-5">
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.h3} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.h4} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
        </Row>
        <div>
          <img src={Img.h5} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.h6} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.h7} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <div>
          <img src={Img.h8} alt="" className="w-100 mb50 mobMb30" />
        </div>
        <Row className="gx-5">
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.h9} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
          <Col lg={6} xs={6}>
            <div>
              <img src={Img.h10} alt="" className="w-100 mb50 mobMb30" />
            </div>
          </Col>
        </Row>
        <div>
          <img src={Img.h11} alt="" className="w-100 mb50 mobMb30" />
        </div>
        ...
        <section>
          <div className="mb80 mobMb15 text-center">
            <h3 className="fs60 mobMb10 mb30 mobFs45 tabFs60">
              <Link to="/pixxley" className="colorWhite">
                Next Project
              </Link>
            </h3>
            <div>
              <Link to="/pixxley">{Svg.arrowDiagnalWhite}</Link>
            </div>
          </div>
        </section>
      </Container>
